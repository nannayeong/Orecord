							...
							<td class="my-con-left">
								<div style="text-align:left">
									<div class="btn-group" style="margin-bottom:1em;margin-left:1em;text-size:16px;">
									  <button type="button" class="btn btn-outline-dark" onclick="location.href='./getParty'">getParty</button>
									  <button type="button" class="btn btn-dark" onclick="location.href='./doParty'">doParty</button>
									</div>
								</div>
								<div id="albumList">
