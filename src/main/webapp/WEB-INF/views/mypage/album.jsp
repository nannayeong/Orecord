						    ...
						    <div class="modal-content"> 
						      ...
						      <div class="modal-body">
						        <div>${pageContext.request.userPrincipal.name}님의 잔여 포인트 :
						        	...
						        	<button type="button" class="btn btn-info btn-sm" style="display:block; float:right; margin-right:20px;"onclick="location.reload();window.open('../chargeLog.do')">충전하기</button>
						        </div>
