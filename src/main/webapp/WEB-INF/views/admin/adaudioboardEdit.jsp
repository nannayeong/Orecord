...
<div>
	<div class="content">
		...
		<form method="post" enctype="multipart/form-data" name="modiform" onsubmit="return modiValidate(this);"
			...
			<s:csrfInput />
			<input type="hidden" name="audio_idx" value="${adaudio.audio_idx}">
				...
				<div class="row">
					<div class="col-8"
							...
							<div class="col-6">
								<div style="padding: 8px 0 5px 0;">
									...
									<input type="text" class="form-control"
										name="artistname" value="${adaudio.artistname }">
								</div>
								<div style="margin-top: 5px;">
									<label>곡 이름</label> <input type="text" class="form-control"
										name="audiotitle" value="${adaudio.audiotitle }">
								</div>
							</div>
							<!-- 작성일, 카테고리 -->
							<div class="col-4 ">
						...
						<div style="padding: 10px 80px 5px 0;">
							<label>음원파일</label>
							<input type="file" class="form-control" value="${adaudio.audiofilename }"
					...
					<div class="col-4" style="padding: 10px 30px 20px 20px;">
						<label>앨범사진</label>
						<input type="file" id="input_file" accept=".jpeg,.jpg,.png" value="${adaudio.imagename }"
			...
			<div style="padding-left: 50px;">
				<textarea name="contents" id="" cols="120" rows="10"
					placeholder="내용을 입력해주세요.">${adaudio.contents }</textarea>
			</div>
			...
			<div class="d-flex flex-row-reverse" style="margin-top: 15px;">
				...
				<div style="margin-right: 10px;">
					...
					onclick="location.href='view.do?audio_idx=${adaudio.audio_idx}'">
						취소
					</button>
				</div>
			</div>
