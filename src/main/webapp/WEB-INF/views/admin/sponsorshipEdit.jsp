        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <div class="table-responsive">
              <form name="registFrm" onsubmit="return isValidate(this);" method="post" enctype="multipart/form-data" action="../admin/sponsorshipEditAction.do?idx=${spondto.idx }">
				<s:csrfInput />
					<!-- 아이디 -->
					<div class="row">
						...
						<div class="input-field col-md-6 pl-md-1">
							<label>후원일</label>
							${spondto.regidate }
							<input type="hidden" value="${spondto.idx }" name="idx">
						</div>
					</div>
					<div class="row">
						<div class="input-field col-md-6 pr-md-1">
							<label>후원금액</label>
							<input type="text" class="form-control" name="sponPoint" value="${spondto.sponPoint }">
						</div>
						<div class="col-md-6 pl-md-1">
							<label>수혜자</label>
							<input type="text" class="form-control" name="patronId" value="${spondto.patronId }">
						<br />
						</div>
					</div>
					<div align="center">
