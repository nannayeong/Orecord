...
<div>
	<div class="content">
		...
		<form name="regiform" onsubmit="return writeValidate(this);" method="post" enctype="multipart/form-data"
			action="<c:url value="/admin/partyEditAction.do?party_idx=${partyBoardDTO.party_idx}"/>">
			<s:csrfInput />
			<input type="hidden" name="party_idx" value="${partyBoardDTO.party_idx}">		
			<!-- content -->
			<div class="row">
				<div class="col-5">
					<div class="form-group">
						...
						<input type="text" class="form-control"
							name="id" value="${partyBoardDTO.id}" readonly style="font-size: 14px;">
					</div>
				</div>
				<div class="col-5">
					<div class="form-group">
						<label>오디오번호</label>
						<input type="text" class="form-control" name="audio_idx" value="${partyBoardDTO.audio_idx}">
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-5">
					<div class="form-group">
						<label>협업분야</label> <select name="kind" id="kind" class="form-control" >
				...
				<div class="col-5">
					<div class="form-group">
						<label>포인트</label> <input type="text" class="form-control"
							name="point" id="point" value="${partyBoardDTO.point }" placeholder="포인트를 입력해주세요">
					</div>
				</div>
				<div class="col-5">
					<div class="form-group">
			...
			<div class="row">
				<div class="col-5">
					<div class="form-group">
						...
						<input type="file" class="form-control" value="${partyBoardDTO.audiofilename }"
			...
			<div class="row">
				<div class="col-10">
					<div class="form-group" style="margin-left: 50px;">
						<label>가사 &nbsp; <span style="color: green;"> * 작사 선택시</span></label>
						<textarea class="form-control" rows="6" id="audiocontents"
							name="audiocontents" placeholder="가사를 입력해주세요">${partyBoardDTO.audiocontents }</textarea>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-5">
					<div class="form-group">
						<label>제목</label> <input type="text" class="form-control" name="title" value="${partyBoardDTO.title }">
					</div>
				</div>
				<div class="col-5">
					<div class="form-group">
				...
				<div class="col-10">
					<div class="form-group" style="margin: 10px 0 0 50px;">
						<label>내용 &nbsp; <span style="color: green;"> *
								전달할 메세지</span></label>
						<textarea name="contents" id="contents" class="form-control" rows="6">${partyBoardDTO.contents }</textarea>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-10">
					<div class="form-group" align="right" style="margin: 40px 30px 0 0;">
