        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <div class="table-responsive">
              <form name="registFrm" onsubmit="return isValidate(this);" method="post" enctype="multipart/form-data" action="../admin/mCommentEditAction.do?comment_idx="${mCommentDTO.comment_idx }>
				<s:csrfInput />
					<!-- 아이디 -->
					<div class="row">
						...
						<div class="input-field col-md-4 px-md-1">
							<label>게시글NO</label>
							${mCommentDTO.audio_idx }
						</div>
						<div class="input-field col-md-4 pl-md-1">
							<label>작성일</label>
							${mCommentDTO.regidate }
						</div>
						<input type="hidden" value="${mCommentDTO.comment_idx }" name="comment_idx">
					</div>
					<div class="row">
						<div class="col-md-12">
							<label>댓글</label>
							<textarea rows="1" cols="80" class="form-control" maxlength="50" name="contents" >${mCommentDTO.contents }</textarea>
						</div>
					</div>
					<div align="center">
						<div>
