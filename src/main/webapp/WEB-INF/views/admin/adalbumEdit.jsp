...
<script type="text/javascript">	
	...
	function isValidate(frm1){
		...
		if(frm.albumName.value=='' || frm.albumName.value==''){
			alert('앨범이름을 입력해주세요.');
			frm.pw.focus();
			return false;
		}
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <div class="table-responsive">
              <form name="registFrm" onsubmit="return isValidate(this);" method="post" enctype="multipart/form-data" action="../admin/adalbumEditAction.do?album_idx=${adalbumEdit.album_idx }">
				<s:csrfInput />
					<!-- 아이디 -->
					<div class="row">
					...
					<div class="row">
						<div class="col-md-6 pr-md-1">
							<label>앨범자켓</label>
			                <input type="file" id="imgFile" accept=".jpeg,.jpg,.png" name="imagename" class="form-control" value="${adalbumEdit.albumJacket }"/>
			                <img id="img_preview" class="inline-block" />
			                <span>앨범이름 : </span> <input type="text" name="albumName" value="${adalbumEdit.albumName }" />
			                <input type="hidden" value="${adalbumEdit.album_idx }" name="album_idx">
						<br />
						</div>
					</div>
					<div align="center">
